...
public class Analista extends Funcionario implements FuncionarioClt{
    ...
    public Analista(String nome, String cargo, int jornadaTrabalho, double bonificacao, double salarioBase, double salarioMes, int descansoRemunerado) {
        super(nome, cargo);
    ...
    public void pagarSalario(double bonificacao, double salarioBase) {
        ...
        System.out.println("O salário do analista é: " + salarioMes);
